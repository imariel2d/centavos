          ...
          <div className="flex flex-wrap gap-2.5">
            {app.storeUrl && (
              <a
                ...
                className="inline-flex items-center gap-2.5 bg-ink text-bg rounded-full pl-4 pr-5 py-2.5 card-hover"
              >
                ...
                <span className="text-left leading-tight">
                  <span className="block text-[9px] opacity-70 uppercase tracking-wide">Descárgala en</span>
            ...
            {app.playUrl && (
              ...
              >
                ...
                <span className="text-left leading-tight">
                  <span className="block text-[9px] opacity-70 uppercase tracking-wide">Disponible en</span>
