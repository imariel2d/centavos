  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="w-9 h-9 rounded-full bg-[#25D366] text-white grid place-items-center hover:opacity-90 transition-opacity"
      >
      ...
      <button
        ...
        className="w-9 h-9 rounded-full bg-surface border border-rule grid place-items-center hover:bg-rule/40 transition-colors"
      >
        {copied ? (
